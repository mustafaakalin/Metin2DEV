...
UPDATE mob_proto SET folder='spider_spawn' WHERE vnum=2095;
UPDATE mob_proto SET folder='yamachun_boss' WHERE vnum=6091;
UPDATE mob_proto SET folder='yamachun_boss' WHERE vnum=4401;
UPDATE mob_proto SET folder='yamachun_boss' WHERE vnum=4411;
UPDATE mob_proto SET folder='yamachun_boss' WHERE vnum=6417;
UPDATE mob_proto SET folder='' WHERE vnum=20221;
UPDATE mob_proto SET folder='pig_young1' WHERE vnum=34017;
UPDATE mob_proto SET folder='dog_young1' WHERE vnum=34018;
UPDATE mob_proto SET folder='tiger_young1' WHERE vnum=34019;
UPDATE mob_proto SET folder='lion_young1' WHERE vnum=34020;
