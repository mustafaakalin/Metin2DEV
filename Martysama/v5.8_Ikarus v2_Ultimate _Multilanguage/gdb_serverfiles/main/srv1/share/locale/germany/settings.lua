...
add_goto_info("ew1", 0, 181, 9728, 1024)
add_goto_info("ew2", 0, 182, 9216, 1536)
add_goto_info("ew3", 0, 183, 9728, 1536)

add_goto_info("OXEVENT", 0, 113, 8964, 215)

add_goto_info("em1", 0, 181, 9728+225, 1024+225)
add_goto_info("em2", 0, 182, 9216+225, 1536+225)
add_goto_info("em3", 0, 183, 9728+225, 1536+225)

-- /goto Grotto
add_goto_info("heaven", 0, 64, 2842, 8105)
add_goto_info("heaven1", 0, 72, 100, 12081)
add_goto_info("heaven2", 0, 73, 2418, 12750)
add_goto_info("heaven3", 0, 208, 8374, 10669)
