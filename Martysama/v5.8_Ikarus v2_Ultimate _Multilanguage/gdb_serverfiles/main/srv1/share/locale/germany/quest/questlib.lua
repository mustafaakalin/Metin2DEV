...
dofile(string.format("%s/quest/libraries/functions.lua", get_locale_base_path()))
dofile(string.format("%s/quest/libraries/globals.lua", get_locale_base_path()))
dofile(string.format("%s/quest/libraries/questlib_extra.lua", get_locale_base_path()))
